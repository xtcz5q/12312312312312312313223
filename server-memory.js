...
server.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`\n╔══════════════════════════════════════════╗`);
  console.log(`║     技能五子棋后端服务已启动             ║`);
  console.log(`╠══════════════════════════════════════════╣`);
  console.log(`║  端口: ${PORT}                          ║`);
  console.log(`╠══════════════════════════════════════════╣`);
  
  ipAddresses.forEach((ip, index) => {
    console.log(`║  访问地址${index > 0 ? ' ' : ''}: http://${ip}:${PORT}    ║`);
  });
  ...
  console.log(`╚══════════════════════════════════════════╝\n`);
  console.log(`已初始化 ${Object.keys(aiPlayers).length} 个AI玩家`);
  console.log(`局域网内其他设备可以使用上述IP地址访问此服务器\n`);
});
